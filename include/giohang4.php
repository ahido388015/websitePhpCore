                ...
                <form action="" method="POST">
                    <table class="timetable_sub">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="7">
                                    Tổng Tiền : <?php echo number_format($total) . 'vnđ' ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7">
                                    ...
                                    ?>
                                        <a class="btn btn-primary" href="index.php?quanly=dangnhap"> Bạn Cần Đăng Nhập Để Thanh Toán</a>
                                    <?php
                                    }
                                    ?>
                                </td>
                    ...
                    <section class="creditly-wrapper wrapper">
                        <div class="information-wrapper">
                            <div class="first-row">
                                ...
                                <div class="controls form-group">
                                    <input type="text" class="form-control" placeholder="Ghi chú" name="note" required="">
                                </div>
                                <div class="controls form-group">
