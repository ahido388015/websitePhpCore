...
<?php 
	 ...
	 $sql_cate = mysqli_query($con, "SELECT * FROM tbl_category, tbl_sampham WHERE tbl_category.category_id=tbl_sampham.category_id AND tbl_sampham.category_id = '$id'  ORDER BY tbl_sampham.sanpham_id DESC ");
	  $sql_category = mysqli_query($con, "SELECT * FROM tbl_category, tbl_sampham WHERE tbl_category.category_id=tbl_sampham.category_id AND tbl_sampham.category_id = '$id'  ORDER BY tbl_sampham.sanpham_id ASC ");
					...
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<form action="#" method="post">
								<input type="search" placeholder="Tìm kiếm thuogn hiệu..." name="search" required="">
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">Đổi Trả 7 ngày  </span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">Bảo Hành Tận Tâm</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
